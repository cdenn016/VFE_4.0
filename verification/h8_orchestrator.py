...
def build_h8_protocol_sha256(config: H8ValidationConfig) -> str:
    ...
    preimage = {
        "domain": "vfe4.h8.parent-child-protocol.v1",
        "validation_config_sha256": config.config_sha256,
        "child_schema": H8_CHILD_SCHEMA_VERSION,
        "child_module": _H8_CHILD_MODULE,
        ...
        "required_operation_order": H8_REQUIRED_OPERATIONS,
